...
Author: Ryan Gast
Date: 1/14/2024
 calculates density for altitudes from sea level
...
def atmosphere(z):
    """
    Calculate the density of the atmosphere at a given altitude.

    Parameters:
    z (float): The altitude in kilometers.

    Returns:
    float: The density of the atmosphere at the given altitude in kg/m^3.
    """
